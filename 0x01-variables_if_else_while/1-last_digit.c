...
/**
 * main- This function prints the last number of a randomly generated integer
 *
 * Description: This function simply gets the last digit of a number by using the Mod operator
